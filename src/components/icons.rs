...
#[component]
pub fn CameraIcon() -> impl IntoView {
    view! {
        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
pub fn PlayIcon() -> impl IntoView {
    view! {
        <svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1.586a1 1 0 01.707.293l2.414 2.414a1 1 0 00.707.293H15M13 16h-1.586a1 1 0 01-.707-.293l-2.414-2.414a1 1 0 00-.707-.293H7"></path>
        </svg>
    }
}

#[component]
pub fn BrainIcon() -> impl IntoView {
    view! {
        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
#[component]
pub fn UtensilsIcon() -> impl IntoView {
    view! {
        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
